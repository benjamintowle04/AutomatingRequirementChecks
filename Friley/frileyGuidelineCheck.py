...
wb_requirementsCheck = load_workbook(
    r"C:/DSSO/AutomatingRequirementChecks/Friley/Shifts.xlsx"
)
...
def main():
    ...
    friley_regular_guideline = getFacilityGuidelineRegular(
        ws_requirements, ws_times_in_need
    )
    friley_supervisor_guideline = getFacilityGuidelineSupervisor(
    ...
    guidelineCheck(
        friley_regular_guideline, friley_supervisor_guideline, employeeList
    )
